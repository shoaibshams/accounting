...
<head>
    ...
    <!-- CSS files -->
    <link href="{{ asset('back/dist/css/tabler.min.css?'. VERSION) }}" rel="stylesheet"/>
    <link href="{{ asset('back/dist/css/tabler-flags.min.css?'. VERSION) }}" rel="stylesheet"/>
    <link href="{{ asset('back/dist/css/tabler-payments.min.css?'. VERSION) }}" rel="stylesheet"/>
    <link href="{{ asset('back/dist/css/tabler-vendors.min.css?'. VERSION) }}" rel="stylesheet"/>
    <link href="{{ asset('back/dist/css/demo.min.css?'. VERSION) }}" rel="stylesheet"/>
    <style>
...
<body>
<script src="{{ asset('back/dist/js/demo-theme.min.js?'. VERSION) }}"></script>
<div class="page">
    <!-- Sidebar -->
                ...
                <ul class="navbar-nav pt-lg-3">
                  ...
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/mail-opened -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
                         stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round"
                         stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path
                                d="M3 9l9 6l9 -6l-9 -6l-9 6"/><path
                                d="M21 9v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-10"/><path d="M3 19l6 -6"/><path
                                d="M15 13l6 6"/></svg>
                  </span>
                            <span class="nav-link-title">
                    Email templates
...
<!-- Libs JS -->
<script src="{{ asset('back/dist/libs/apexcharts/dist/apexcharts.min.js?'. VERSION) }}" defer></script>
<script src="{{ asset('back/dist/libs/jsvectormap/dist/js/jsvectormap.min.js?'. VERSION) }}" defer></script>
<script src="{{ asset('back/dist/libs/jsvectormap/dist/maps/world.js?'. VERSION) }}" defer></script>
<script src="{{ asset('back/dist/libs/jsvectormap/dist/maps/world-merc.js?'. VERSION) }}" defer></script>
<!-- Tabler Core -->
<script src="{{ asset('back/dist/js/tabler.min.js?'. VERSION) }}" defer></script>
<script src="{{ asset('back/dist/js/demo.min.js?'. VERSION) }}" defer></script>
<script>
    // @formatter:off
